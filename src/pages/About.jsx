  ...
  <div className="absolute inset-0 bg-white/5" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Main Heading */}
            <h1
              className="text-3xl md:text-5xl lg:text-6xl font-bold text-gray mb-6 leading-tight"
          ...
          >
            ...
            <div className="space-y-4 text-neutral-700 leading-relaxed" style={{ fontFamily: 'Lato, sans-serif' }}>
              ...
              <div className="bg-primary-50 border-l-4 border-primary-500 p-5 md:p-6 rounded-r-xl my-6">
                <p className="text-base md:text-lg font-semibold text-neutral-900 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-12">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-neutral-700 max-w-3xl mx-auto" style={{ fontFamily: 'Lato, sans-serif' }}>
