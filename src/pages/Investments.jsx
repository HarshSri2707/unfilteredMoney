...
//   const filteredProducts = investmentsData.allInvestments.filter((p) => {
...
//             title: 'Investments\nMake Your Money Work While You Sleep.',
//             description: [
//               'Keeping cash in a savings account loses you money due to inflation. Investing is the only way to build real wealth.',
//               'Whether you are risk-averse or a risk-taker, there is an asset class for you.',
//             ],
//             points: [
//               { title: 'Mutual Funds & SIPs', description: 'Turn small monthly savings into large corpus.', icon: '📊' },
//               { title: 'Stock Market', description: 'Own shares of companies you believe in.', icon: '📈' },
//               { title: 'Gold & Fixed Income', description: 'Safe havens for preserving wealth.', icon: '🪙' },
//               { title: 'Start Early', description: 'Compounding works best when you give it time.', icon: '⏳' },
//             ],
//           }}
//         />
//         <FilterBar
...
//         />
//         <TopPicks
//           picks={investmentsData.topPicks}
//           type="investments"
//           onProductClick={setSelectedProduct}
...
//           products={filteredProducts}
//           type="investments"
//           title={isFiltered ? `Results (${filteredProducts.length})` : 'All Investments'}
//           onProductClick={setSelectedProduct}
//           searchValue={searchValue}
//         />
//         <FAQ faqs={investmentsData.faqData} />
    ...
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
        <Hero
          data={{
            title: 'Investments\nMake Your Money Work While You Sleep.',
            highlightWord: 'While You Sleep.',
            heroImage: 'images/banner/Investments main page image.png',
            description: [
              'Keeping cash in a savings account loses you money due to inflation. Investing is the only way to build real wealth.',
              'Whether you are risk-averse or a risk-taker, there is an asset class for you.',
            ],
            ...
            tip: {
              ...
              text: 'Start with a simple SIP in an index fund — low cost, diversified, and proven over time.',
            },
          }}
        />
        <FilterBar
