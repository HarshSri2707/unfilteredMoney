        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3
                  className="text-sm md:text-base font-semibold text-neutral-900 pr-4 leading-snug"
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div
                      className="px-5 pb-5 text-sm text-neutral-600 leading-relaxed text-justify"
                      style={{ fontFamily: 'Lato, sans-serif' }}
                    >
                      {faq.answer}
                    </div>
