                ...
                <Card hover>
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${categoryColors[blog.category]}`}>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-neutral-200">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <p className="text-xs font-medium text-neutral-700">{blog.author}</p>
                          <p className="text-xs text-neutral-500">{blog.publishedDate}</p>
                        </div>
                      </div>
