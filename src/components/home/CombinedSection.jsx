...
const CombinedSection = () => {
  const categories = [
    {
      ...
      name: 'Credit Cards',
      description: 'Best cards with zero hidden fees',
      link: '/credit-cards',
    },
    {
      icon: (
      ...
      name: 'Insurance',
      description: 'Policies with best claim ratios',
      link: '/insurance',
    },
    {
      icon: (
      ...
      name: 'Investments',
      description: 'Funds with proven track records',
      link: '/investments',
    },
  ];
  ...
  return (
    <>
      {/* ══ SECTION 1 — EXPLORE FINANCIAL PRODUCTS ══ */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {topPicks.map((pick, index) => (
              <motion.div
                ...
                className="h-full"
              >
                <div className="group bg-white rounded-2xl border-2 border-neutral-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col h-full">

                  {/* ── IMAGE — p-3 outer, rounded-xl inner ── */}
                  <div className="relative w-full shrink-0 bg-neutral-50 p-3">
                    <div className="relative h-52 sm:h-44 md:h-48 w-full overflow-hidden rounded-xl">
                      <img
                        src={pick.img}
                        alt={pick.name}
                        className="w-full h-full object-contain-cover transition-transform duration-500 "
                      ...
                      {/* ── RATING BADGE — glassmorphism, dark transparent, blur, bottom-right ── */}
                      {pick.rating && (
                        <div
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mb-4">
                      <h3
                        className="text-lg font-bold text-neutral-900 mb-0.5 group-hover:text-primary-600 transition-colors"
                        style={{ fontFamily: 'Lato, sans-serif' }}
                      >
                        {pick.name}
                      </h3>
                    ...
                    <div className="mb-5 flex-1">
                      <p className="text-[13px] font-bold text-neutral-700 mb-1.5" style={{ fontFamily: 'Lato, sans-serif' }}>
                        Benefits & Features
                      </p>
                      <p className="text-[13px] font-semibold text-neutral-500 leading-relaxed" style={{ fontFamily: 'Lato, sans-serif' }}>
                        {pick.pros
                          ? pick.pros.slice(0, 2).join('. ')
                          : pick.description || ''}
                      </p>
                    ...
                    <div className="border-t border-neutral-200 pt-4 mb-5 space-y-2">
                      ...
                      {pick.type === 'insurance' && (
                        <>
                          <div className="flex justify-between text-sm">
                            <span className="font-semibold text-neutral-500" style={{ fontFamily: 'Lato, sans-serif' }}>Coverage</span>
                            <span className="font-bold text-neutral-900" style={{ fontFamily: 'Lato, sans-serif' }}>{pick.coverage || '5L'}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="font-semibold text-neutral-500" style={{ fontFamily: 'Lato, sans-serif' }}>Claim Ratio</span>
                            <span className="font-bold text-neutral-900" style={{ fontFamily: 'Lato, sans-serif' }}>{pick.claimSettlement || '96.8%'}</span>
                          </div>
                        </>
                      )}
                      {pick.type === 'investment' && (
