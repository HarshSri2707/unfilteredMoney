...
//             <span className="text-primary-600">UnfilteredMoney?</span>
//           </h2>
//           <p className="mt-2 text-sm md:text-base font-semibold text-neutral-500" style={{ fontFamily: 'Lato, sans-serif' }}>
//             We're not another comparison site. We're your financial forensic team.
//           </p>
//         </motion.div>
...
//                 {reason.icon}
//               </div>
//               <h3 className="text-sm md:text-base font-extrabold text-neutral-900 mb-2" style={{ fontFamily: 'Lato, sans-serif' }}>
//                 {reason.title}
//               </h3>
//               <p className="text-xs md:text-sm font-semibold text-neutral-500 leading-relaxed text-justify" style={{ fontFamily: 'Lato, sans-serif' }}>
//                 {reason.description}
//               </p>
//             </motion.div>
//           ))}
    ...
    <section className="py-10 md:py-14 bg-white overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-3 text-sm md:text-base font-semibold text-neutral-500" style={{ fontFamily: 'Lato, sans-serif' }}>
            We're not another comparison site. We're your financial forensic team.
          </p>
        </motion.div>
        ...
        >
          {reasons.map((reason, idx) => (
            <motion.div
              key={idx}
              variants={cardVariants}
              className="bg-white rounded-2xl border border-neutral-200 p-6 md:p-7 hover:shadow-md transition-all duration-300"
            >
              {/* Icon circle */}
              <div className="w-12 h-12 rounded-full bg-primary-50 flex items-center justify-center mb-5">
                {reason.icon}
              </div>
              <h3 className="text-sm md:text-base font-extrabold text-neutral-900 mb-3" style={{ fontFamily: 'Lato, sans-serif' }}>
                {reason.title}
              </h3>
              <p className="text-xs md:text-sm font-semibold text-neutral-500 leading-relaxed text-justify" style={{ fontFamily: 'Lato, sans-serif' }}>
                {reason.description}
