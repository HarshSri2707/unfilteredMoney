        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                {/* Circle Icon */}
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-primary-600 flex items-center justify-center mb-5 shadow-md">
                  <Icon size={24} strokeWidth={2} className="text-white" />
                </div>

                <h3
                  className="text-sm md:text-base font-extrabold text-neutral-900 mb-2"
                  style={{ fontFamily: 'Lato, sans-serif' }}
                >
                  {step.title}
                </h3>
