...
// //                   <Link
// //                     to={link.path}
// //                     className={`flex items-center gap-1.5 px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold rounded-full transition-colors whitespace-nowrap ${
...
//       path: '/credit-cards',
//       dropdown: [
//         // ── "All" option — pehle, divider ke baad baki options ──
//         { name: 'All Credit Cards', path: '/credit-cards', isAll: true },
//         { name: 'Best Lifetime Free Cards', path: '/credit-cards/lifetime-free' },
//         { name: 'Best for Travel', path: '/credit-cards/travel' },
//         { name: 'Best for Cashback', path: '/credit-cards/cashback' },
//       ],
...
//       path: '/insurance',
//       dropdown: [
//         { name: 'All Insurance Plans', path: '/insurance', isAll: true },
//         { name: 'Term Life Insurance', path: '/insurance/term-life' },
//         { name: 'Health Insurance', path: '/insurance/health' },
//         { name: 'Motor Insurance', path: '/insurance/vehicle' },
//       ],
...
//       path: '/investments',
//       dropdown: [
//         { name: 'All Investments', path: '/investments', isAll: true },
//         { name: 'Mutual Funds', path: '/investments/mutual-funds' },
//         { name: 'Stock Market', path: '/investments/stocks' },
//         { name: 'Fixed Income', path: '/investments/fixed-income' },
//       ],
...
//   // Mobile hamburger menu - non-category links
//   const mobileOnlyLinks = [
//     { name: 'Home', path: '/' },
//     { name: 'Blogs', path: '/blog' },
//     { name: 'About Us', path: '/aboutus' },
...
//                   {/* Desktop dropdown — hover, All option first with divider */}
//                   <AnimatePresence>
//                     {activeDropdown === link.name && (
//                       <motion.div
//                         className="absolute top-full left-0 mt-2 w-52 sm:w-56 bg-white rounded-xl shadow-xl border border-neutral-100 py-2 z-50"
...
//                 {/* Category links — click to toggle accordion (mobile pe hover nahi hota) */}
//                 {categoryLinks.map((link) => (
//                   <div key={link.name}>
//                     <button
//                       onClick={() =>
...
//                         )
//                       }
//                       className={`w-full flex items-center justify-between px-3 py-3.5 text-base font-semibold rounded-lg transition-colors ${
//                         location.pathname.startsWith(link.path)
//                           ? 'text-primary-600 bg-primary-50'
//                           : 'text-neutral-800 hover:bg-neutral-50'
//                       }`}
...
//                                     item.isAll
//                                       ? 'font-bold text-primary-600 hover:bg-primary-50'
//                                       : 'font-semibold text-neutral-600 hover:bg-neutral-50 hover:text-primary-600'
//                                   }`}
//                                   style={{ fontFamily: 'Lato, sans-serif' }}
//                                 >
//                                   {item.name}
//                                 </Link>
//                                 {item.isAll && (
//                                   <div className="h-px bg-neutral-100 mx-3 my-0.5" />
//                                 )}
//                               </div>
//                             ))}
//                           </div>
...
//                     {activeDropdown === link.name && (
//                       <motion.div
//                         className="absolute top-full left-0 mt-2 w-52 sm:w-56 bg-white rounded-xl shadow-xl border border-neutral-200 py-2 z-50"
//                         initial={{ opacity: 0, y: -6 }}
//                         animate={{ opacity: 1, y: 0 }}
//                         exit={{ opacity: 0, y: -6 }}
//                         transition={{ duration: 0.15 }}
