...
//       name: 'HDFC Regalia',
//       bank: 'HDFC Bank',
//       image: 'https://v.hdfcbank.com/content/dam/hdfc-aem-microsites/htdocs/common/2021/August/business_card_calc/images/cards/business_regalia.png',
//       category: 'travel',
//       rating: '4.5',
//       annualFee: '₹2,500',
...
//       name: 'Axis Magnus',
//       bank: 'Axis Bank',
//       image: 'https://www.credithita.com/images/cards/axis-bank-magnus-credit-card.jpg',
//       category: 'premium',
//       rating: '4.7',
//       annualFee: '₹10,000',
...
//       bank: 'SBI Card',
//       image: 'https://www.paisabazaar.com/wp-content/uploads/2021/12/SBI-SimplyCLICK-Credit-Card.png',
//       category: 'cashback',
//       rating: '4.2',
//       annualFee: '₹499',
...
//       name: 'ICICI Sapphiro',
//       bank: 'ICICI Bank',
//       image: 'https://www.fincover.com/image/partners/credit-cards/ICICI-Bank-Sapphiro-Credit-Card.png.webp',
//       category: 'travel',
//       rating: '4.4',
//       annualFee: '₹3,500',
...
export const creditCardsData = {
  topPicks: [
    {
      ...
      rating: '4.5',
      annualFee: '₹2,500',
      feeWaiver: 'On ₹4L annual spend (Regalia Gold variant)',
      pros: [
        'Great airport lounge access (domestic & international)',
        'Good reward points on dining, travel & milestones',
        'Complimentary golf & lifestyle perks'
      ],
      cons: [
        'Annual fee if spend target not met',
        'Limited fuel surcharge waiver'
      ],
      bestFor: 'Frequent travelers who value lounge access & premium benefits',
      featured: true
    },
    {
      id: 'axis-magnus',
      ...
      image: 'https://www.credithita.com/images/cards/axis-bank-magnus-credit-card.jpg',
      category: 'premium',
      rating: '4.6', // slightly adjusted after recent changes
      annualFee: '₹10,000',
      feeWaiver: 'None (but high vouchers/milestones)',
      pros: [
        'High reward rate (accelerated tiers up to credit limit + ₹1.5L)',
        'Excellent milestone & travel benefits',
        'Premium lifestyle & concierge perks'
      ],
      cons: [
        'Very high annual fee',
        'Reward structure capped/changed in 2025'
      ],
      bestFor: 'High spenders seeking luxury travel & milestone rewards',
      featured: true
    },
    {
      id: 'amazon-pay',
      ...
      cons: [
        'Benefits mainly Amazon & Amazon Pay focused',
        'No lounge access or travel perks'
      ],
      bestFor: 'Amazon shoppers, online spenders & beginners',
      featured: true
    }
  ],
  ...
  allCards: [
    ...
    },
    {
      ...
      rating: '4.6',
      annualFee: '₹10,000',
      feeWaiver: 'None (vouchers/milestones instead)',
      pros: [
        'Excellent milestone benefits',
    ...
    },
    {
      ...
      rating: '4.2',
      annualFee: '₹499',
      feeWaiver: 'On ₹1L–2L annual spend',
      pros: [
        '10X rewards on partner online spends (Amazon, Myntra, etc.)',
        '1% fuel surcharge waiver'
      ],
      bestFor: 'Online shoppers',
      featured: false
    },
    {
      ...
      category: 'lifetime-free',
      rating: '4.1',
      annualFee: '₹500 (2nd year onward)',
      feeWaiver: 'On ₹3.5L+ annual spend',
      pros: [
        '5% unlimited cashback on Flipkart',
        '4% on preferred partners (Swiggy, PVR, etc.)'
      ],
      bestFor: 'Flipkart & partner ecosystem shoppers',
      featured: false
    },
    {
      id: 'icici-sapphiro',
...
categories: [
  ...
  faqData: [
    {
      question: 'Will getting a credit card hurt my credit score?',
      answer: 'No. Applying for too many at once might, but having one and paying bills on time actually improves your score.'
    },
    {
      question: 'What is the "Minimum Amount Due"?',
      answer: 'It’s a trap. It’s a small portion of your bill you can pay to avoid late fees, but you will still be charged huge interest on the rest. Always pay the full amount.'
    },
    {
      question: 'Which is the best credit card for beginners?',
      answer: 'Lifetime free cards like Amazon Pay ICICI or Flipkart Axis are best for beginners to build credit history without annual fees.'
    },
    {
      question: 'How to choose the right credit card?',
      answer: 'Choose based on your lifestyle: travel → lounge access cards; online shopping → cashback cards; beginners → lifetime free cards. Always pay full bill on time.'
    },
    {
      question: 'Can I get credit card annual fee waived?',
      answer: 'Yes, most good cards waive the annual fee if you meet spending thresholds (usually ₹1L–4L per year).'
    }
  ],

  tips: [
    {
      title: 'Always Pay Full Statement Balance',
      description: 'Avoid interest & keep rewards safe',
      detail: 'Paying only minimum due charges high interest (3–4% p.m.) & you may lose accrued rewards points.'
    },
    {
      title: 'Start with Lifetime Free Cards',
      description: 'Build credit without fees',
      detail: 'Amazon Pay ICICI & Flipkart Axis are excellent no-fee starters for online spenders.'
    },
    {
      title: 'Match Card to Spending',
      description: 'Maximize real value',
      detail: 'Travel a lot? → lounge cards. Amazon/Flipkart lover? → cashback cards. High spender? → premium milestone cards.'
    },
    {
      title: 'Avoid Multiple Applications',
      description: 'Protect your CIBIL score',
      detail: 'Each hard inquiry drops score temporarily. Space applications 3–6 months apart.'
    }
  ]
};